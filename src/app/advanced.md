...
在[【应用设置】→【关于】](classisland://app/settings/about)中连续点击最上方的应用图标 10 次，即可启用应用本体的[调试](classisland://app/settings/debug)与其他插件的调试界面。

::: danger 注意！
调试菜单中的功能仅供测试使用，如果您不知道您在做什么，请不要随意使用。本功能可在集控管理中禁用。
:::
