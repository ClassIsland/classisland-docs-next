...
在界面左侧可以选择要编辑的时间表，在中间可以编辑时间表。时间表编辑器具有**列表和时间轴**两种视图模式，您可以点击下方的按钮来进行切换。建议您使用更为简介直观的时间轴视图进行编辑，如果您认为时间轴视图中进行编辑不够方便，也可以切换到列表视图进行编辑。两种视图的编辑模式几乎相同。
...
对于【行动】时间点，请参阅[【自动化】](../automation.md)页面获取关于行动的相关信操作教程。
