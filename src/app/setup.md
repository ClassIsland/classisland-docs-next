...
::: note 对 Windows 7 系统的支持
由于 Windows 7 已于 2020 年 1 月 14 日结束支持，ClassIsland 2 不再支持在 Windows 7 上运行。如果您仍在使用 Windows 7，可以从[这里](https://www.classisland.tech/download/v1)下载适用于 Windows 7 的 ClassIsland 1.6.0.5 版本。但请注意该版本不会再收到任何更新，可能存在未修复的安全漏洞和兼容性问题。建议您升级到受支持的操作系统以获得更好的性能与安全性。对于在不受支持系统上运行 ClassIsland 时出现的任何问题，我们将不提供技术支持。
:::
...
如果您想体验最新功能，可以前往[GitHub Actions](https://github.com/ClassIsland/ClassIsland/actions/workflows/build_release.yml)下载带有最新变更的构建。如果您想自行构建 ClassIsland，请参考[开发文档](../dev/get-started/development.md)。
:::
