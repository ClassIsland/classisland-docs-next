...
如果您想体验最新的功能，可以前往[GitHub Actions](https://github.com/ClassIsland/ClassIsland/actions/workflows/build_release.yml)下载包含最新功能的构建。如果您想自行构建 ClassIsland，请参考[开发文档](../dev/get-started/development.md)。
:::
...
| 下载链接 | 密码 | 来源 | 更新日期 | 能否更新至v2 |
|:--:|:--:|:--:|:--:|:--:|
| <https://wwz.lanzouv.com/b00tao8lwb> | 0556 | [MC_Sky](https://bilibili.com/read/cv35699004) | 2024-06-22 | 否 [^3] |
| <https://pan.quark.cn/s/40d1dca97c3d> | | | 2024-08-07 | 否 [^3] |
