...
> [!warning]
> 默认情况下，ClassIsland 使用 RawInput 来接收输入事件。这种方法可以允许 ClassIsland 分别对鼠标和触摸输入做出更适合的响应，但兼容性不佳。默认设置中该选项已经关闭，您可以在[【应用设置】→【窗口】](classisland://app/settings/window)】中手动开启【使用原始输入】选项。
...
![时间点结束倒计时](image/basic/时间点结束倒计时.png)
