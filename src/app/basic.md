...
您可以通过[【插件管理】](classisland://app/settings/plugins)界面查看、安装、更新和卸载插件：

- **安装插件**：点击"添加插件"按钮，从官方插件库或本地文件安装插件
- **启用/禁用插件**：通过插件列表中的开关控制插件的激活状态
- **插件设置**：部分插件提供自定义设置选项，可在插件详情中配置


### 官方插件库

ClassIsland 提供了一系列官方维护的插件，包括：

- **天气信息插件**：在主界面显示实时天气数据
- **系统状态插件**：监控系统资源使用情况
- **日历集成插件**：与外部日历服务同步
- **课堂工具插件**：提供快速访问教学工具的功能

您可以在[【插件中心】](classisland://app/store/plugins)浏览和下载官方及社区开发的插件。
